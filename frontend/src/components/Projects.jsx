        ...
        <div className="px-6 flex flex-col h-screen text-black overflow-visib;e">
            ...
            <div className="flex flex-col mx-10">
                <div className="flex flex-row flex-wrap justify-center h-full" role="list">
                    ...
                    <div onClick={() => handleClick("Photo Gallery",
                        "Delayed",
                        ["Flutter", "Git"],
                    ...
                    <div onClick={() => handleClick("UReact",
                        "Aug 2023 - May 2024",
                    ...
                    <div onClick={() => handleClick("Chat Web App",
                        "Jan 2023 - May 2024",
                    ...
                    <div onClick={() => handleClick("LMS Website",
                        "Aug 2023 - Dec 2023",
                    ...
                    <div onClick={() => handleClick("LMS Database",
                        "Jan 2023 - May 2023",
                    ...
                    <div onClick={() => handleClick("Lifestyle App",
                        "Jan 2023 - Apr 2023",
                    ...
                    <div onClick={() => handleClick("LWC Search",
                        "Feb 2022 - Feb 2022",
                    ...
                    <div onClick={() => handleClick("Field History Tracking",
                        "Jul 2021 - Nov 2021",
