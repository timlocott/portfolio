...
function Projects(){
    ...
    function handleClick(_title, _dateRange, _skills, _description, _hasWebsiteLink, _websiteLink = ""){
        openModal();
        setTitle(_title);
        ...
        <div className="px-6 flex flex-col h-screen text-black overflow-visib;e">
            ...
            <div className="flex flex-col mx-10">
                <div className="flex flex-row flex-wrap justify-center h-full" role="list">
                    <div title="project" onClick={() => handleClick("Portfolio",
                        "Jun 2024 - Present",
                    ...
                    <div title="project" onClick={() => handleClick("Photo Gallery",
                        "Delayed",
                        ["Flutter", "Git"],
                    ...
                    <div title="project" onClick={() => handleClick("UReact",
                        "Aug 2023 - May 2024",
                    ...
                    <div title="project" onClick={() => handleClick("Chat Web App",
                        "Jan 2023 - May 2024",
                        ["React", "JavaScript", "Tailwind CSS", "Python", "FastAPI", "SQLite", "REST"],
                        ...
                        <ProjectCard imgSrc={chatClient} textColor="text-white" projTitle="Chat Web App" />
                    </div>
                    <div title="project" onClick={() => handleClick("LMS Website",
                        "Aug 2023 - Dec 2023",
                        ["HTML", "CSS", "JavaScript", "Python", "Django", "AJAX", "jQuery"],
                    ...
                    <div title="project" onClick={() => handleClick("LMS Database",
                        "Jan 2023 - May 2023",
                    ...
                    <div title="project" onClick={() => handleClick("Lifestyle App",
                        "Jan 2023 - Apr 2023",
                        ["Kotlin", "Git", "Android Studio", "Google Material Design", "Kotlin Coroutines"],
                    ...
                    <div title="project" onClick={() => handleClick("LWC Search",
                        "Feb 2022 - Feb 2022",
                        ["LWC", "CRM", "Apex", "CSS", "HTML5", "Salesforce Trailblazer Rank: Expeditioner"],
                    ...
                    <div title="project" onClick={() => handleClick("Field History Tracking",
                        "Jul 2021 - Nov 2021",
                        ["CRM", "Apex", "Salesforce Trailblazer Rank: Expeditioner", "OOP"],
